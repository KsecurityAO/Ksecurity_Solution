...
const AmeacasTop = () => {
  ...
  return (
    <section className={`${styles.wrapper} md:grid md:grid-cols-3 md:grid-rows-1 gap-3 flex flw-wrap  flex-col p-3`}>

{/* Graficos Incidentes na Infraestrutura */}
 ...
 {/* Graficos das Amecas Detetadas */}
        <div className=' text-whiteText bg-Bgreen-transparent rounded-md md:ml-8'>
        ...
        {/* Grafico de Perfomance do servidor */}
        <div className=' text-whiteText bg-Bgreen-transparent rounded-md'>
        ...
        <div className={` flex flex-wrapper justify-around`} style={{ height: '6rem'}}>
            ...
            <div className='flex flex-wrap justify-around'>
              <span className={styles.iconAmeacas1}>Resolvidos </span>
              <span className={styles.iconAmeacas2}>Não Resolvidos </span>
            </div>
        </div>
